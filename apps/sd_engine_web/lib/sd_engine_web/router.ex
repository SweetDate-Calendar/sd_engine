defmodule SDWeb.Router do
  ...
  scope "/", SDWeb do
    ...
    live "/events/:id/users/", EventUserLive.Form, :new
    live "/events/:event_id/users/:user_id/edit", EventUserEditLive.Form, :edit
    ...
    live "/tenants/:id/users", TenantUsersLive.Form, :new
    live "/tenants/:tenant_id/users/:id/edit", TenantUsersEditLive.Form, :edit
